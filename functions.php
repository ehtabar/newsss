...
define( 'MTS_THEME_VERSION', '3.1.6' );
...
function mts_enqueue_css() {
	...
	if ( ! empty( $mts_options['mts_author_comment'] ) ) {
		$mts_author = '.bypostauthor { padding: 3%!important; background: #fafafa; border-radius: 4px; box-shadow: 0 3px 3px rgba(0,0,0,.15); width: 94%!important; color: #1f1f1f; }
